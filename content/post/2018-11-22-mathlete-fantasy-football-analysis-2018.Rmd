...
For the last two years I've had the honor of being the commisioner for the West Point Department of Mathematical Sciences's Fantasy Football League.  This year we had 20 managers so we had to split our department into two leagues.  I hosted one using ESPN and a colleague hosted on in Yahoo. 

In order to compare our two leagues, I will use the ESPN API and YAHOO API to download our league's information.  I'll join the two leauges and identify the top scoring teams each week and conduct some other comparitive analysis.  
...
Then, download the data.  The API will download your informaiton in JSON format.  You'll need to convert it to a format you can work with in R.
...
Full disclaimer here.  I have yet to figure out how to access this saved code.  I have been recreating a passcode everytime I run this.  I would love it if someone could show me how to do this.
