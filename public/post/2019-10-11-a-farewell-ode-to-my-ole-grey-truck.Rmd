...
Well, maybe I'm taking too much historical licence, but man's affinity for their transportation remains.  
...
```{r include=FALSE}
truck = read_csv("FordF150ode.csv") %>% select(-Notes)
```
...
<center>
<img src="/bothedit.jpg" alt="bothedit" width="400">
</center>
